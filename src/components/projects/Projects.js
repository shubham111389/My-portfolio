    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 xl:gap-14">
        ...
        <ProjectsCard
          ...
          des=" 📺 Welcome to our React-powered FOOD_Haven🍔 Web-app Discover your favourite restaurnat with ease through advanced search 🔍,  Add Favourate dishes to your cart 🛒 and login 🔑 hassle-free.,Enjoy a yummy design 🍽️ while you explore a world of flavors! 🚀👨‍🍳🎉"
          src={projectTwo}
        />
        <ProjectsCard
